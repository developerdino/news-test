...
hostname        = "news.10.20.20.20.xip.io"
...
mysql_root_password   = "news"   # We'll assume user "root"
mysql_version         = "5.5"    # Options: 5.5 | 5.6
mysql_enable_remote   = "false"  # remote access enabled when true
pgsql_root_password   = "news"   # We'll assume user "root"
mariadb_root_password = "news"   # We'll assume user "root"
